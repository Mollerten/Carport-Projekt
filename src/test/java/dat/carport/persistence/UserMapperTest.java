...
class UserMapperTest
{
    ...
    {
        User expectedUser = new User("user","test@mail.com","1234", "88888888", "testvej 28", "testby");
    ...
    {
        User newUser = UserFacade.createUser("jill", "test@mail.com", "user", "88888888", "testvej 28", "testby", connectionPool);
        User logInUser = UserFacade.login("jill","1234", connectionPool);
        User expectedUser = new User("jill", "test@mail.com", "user", "88888888", "testvej 28", "testby");
